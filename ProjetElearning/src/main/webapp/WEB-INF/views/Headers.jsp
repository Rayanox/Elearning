...
<% //Initialisation des URL 
	SessionBean sess = (SessionBean) session.getAttribute("sessionBean");
	String url_EDT = "", url_DashBoard = "", url_Course = "", url_Control = "", url_Accueil="", url_login
			, url_Deconnexion;
	if(sess.getStatus().equals(Status.Etudiant)) {
		url_EDT = "./EDT";
...
%>
	...
	<div style="margin: 10px" class=""> <!-- Conteneur menu -->		
	  <ul class="nav nav-pills col-md-9">
		  ...
		  <li class="active"><a href="<%=url_DashBoard %>"><span class="glyphicon glyphicon-list-alt"></span> Tableau de Bord</a></li>
		  <li><a href="<%=url_EDT %>"><span class="glyphicon glyphicon-calendar"></span> Emploi du temps</a></li>
		  <li><a href="<%=url_Course %>"><span class="glyphicon glyphicon-book"></span> Cours</a></li>
		  <li><a href="<%=url_Control %>"><span class="glyphicon glyphicon-saved"></span> Contrôles</a></li>
		  <% } else {%>
		  	<li><a href="<%=url_Accueil %>"><span class="glyphicon glyphicon-saved"></span> Accueil</a></li>
		  <% } %>
		</ul>
		...
		<ul class="nav nav-pills pull-right">
		  ...
		  <li><a href="<%=url_Deconnexion %>"><span class="glyphicon glyphicon-off"></span> Déconnexion</a></li>
		  <%} else {%>
		  <li><a href="<%=url_login %>"><span class="glyphicon glyphicon-off"></span> Connexion</a></li>
		  <% } %>
		</ul>
